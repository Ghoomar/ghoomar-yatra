    ...
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-stone-200 bg-white/95 px-4 md:px-6 backdrop-blur-xs">
      <div className="flex items-center gap-3">
        <button
          ...
          className="lg:hidden rounded-lg p-2 text-stone-600 hover:bg-stone-100 focus:outline-none"
          aria-label="Open sidebar"
        >
          <Menu className="h-5 w-5" />
        </button>

        <div className="flex items-center gap-2 rounded-lg bg-stone-100 px-3 py-1.5 border border-stone-200/80 text-xs md:text-sm font-medium text-stone-700">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        <Link
          ...
          className="flex items-center gap-1.5 rounded-lg bg-amber-50 border border-amber-200 px-2.5 py-1.5 text-xs font-semibold text-amber-800 hover:bg-amber-100 transition-colors shadow-2xs"
        >
          <Car className="h-3.5 w-3.5 text-amber-700" />
          <span className="hidden md:inline">Gate Counter</span>
        </Link>

        <div className="flex items-center gap-1.5 rounded-lg border border-stone-200 bg-stone-50 px-2.5 py-1 text-xs">
